...
def pixelshuffle(layer_in, scale):
    print('  !!!!!!!!!!!!!!!!!!    this is the layer_in    !!!!!!!!!!!!!!!!' , layer_in , scale)
    return tf.nn.depth_to_space(layer_in, block_size=scale) # here I changes :  block_size=scale :  to :  block_size=2*scale  : 
...
def DFCAN(input_shape, scale=2):
    ...
    print(pixelshuffle, type(pixelshuffle), '-------------------------!!!!!!!!!!!!!!    pixel shuffel being printed   !!!!!!!!!!!!!!! V')
